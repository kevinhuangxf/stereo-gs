...
class PairViewer (BasePCOptimizer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if confs[0] > confs[1]:
            ...
            # print('Using pair 0-1')
            # print(self.pred_j['0_1'].shape)
            # print(self.pred_i['0_1'][..., 2].shape)
            ...
            # print('Using pair 1-0')
            # print(self.pred_j['1_0'].shape)
            # print(self.pred_j['1_0'][..., 2].shape)
