"""
Inference script for StereoGS model with pre-generated multi-view images.
Supports configurable N input views from a folder of images.

Usage:
    # 4 views (default):
    python infer_v3d.py stereogs \
        --resume ./ckpts/241113_mast3r/model.safetensors \
        --workspace ./output \
