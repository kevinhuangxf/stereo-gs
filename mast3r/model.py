...
class AsymmetricMASt3R(AsymmetricCroCo3DStereo):
    ...
    def set_downstream_head(self, output_mode, head_type, landscape_only, depth_mode, conf_mode, patch_size, img_size, **kw):
        ...
        # Only create mv_head when using mv_head mode (not using unet refinement)
        if head_type == 'mv_head':
            self.mv_head = mast3r_head_factory('mv_head', output_mode, self, has_conf=bool(conf_mode), use_offsets=self.use_offsets, sh_degree=self.sh_degree)
        # magic wrapper
